...
export default class WebformBuilder extends Component {
    ...
    constructor() {
        ...
        this.options.hooks.renderComponent = (html, { component, self }) => {
            ...
            return this.renderTemplate('builderComponent', {
                html,
                //noteloi disableBuilderActions: self ? self.component ? self.disableBuilderActions,
    ...
    onDrop(element, target, source, sibling) {
        ...
        const compKey = (group === 'resource') ? `component-${key}` : key;
        //noteloi const draggableComponent = this.groups[group] ? .components[compKey] || {};
    ...
    highlightInvalidComponents() {
        ...
        this.webform.everyComponent((comp) => {
            ...
            //noteloi } else if (comp.error ? .message ? .startsWith('API Key is not unique')) {
